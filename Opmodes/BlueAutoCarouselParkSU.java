...
/**
 ...
 This file's path is: FtcRobotController/TeamCode/java/org.firstinspires.ftc.teamcode/Opmodes/BlueAutoCarouselParkSU.java
 **/
...
@Autonomous(name="New Blue Carousel SU Park", group="Linear Opmode")
public class BlueAutoCarouselParkSU extends LinearOpMode {
...
//                  robot.arm.setPower(ARM_HOLDING_POWER);
                ...
                case gotoCarousel:
                    ...
                    sleep(100);
                    runtime.reset();
                    robot.startStrafeToPosition(0.5, 17);
                    while (opModeIsActive() &&
                            (runtime.milliseconds() < timeout_ms) &&
                            (robot.FLMotor.isBusy() && robot.FRMotor.isBusy())) {
                    }
...
//                    sleep(100);
                    ...
                    runtime.reset();
                    robot.startStrafeToPosition(0.5, -60);
                    timeout_ms = 5000;
                    while (opModeIsActive() &&
                            (runtime.milliseconds() < timeout_ms) &&
                            (robot.FLMotor.isBusy() && robot.FRMotor.isBusy())) {
                    ...
                    runtime.reset();
                    timeout_ms = 3000;
                    robot.startDriveToPosition(0.5, 10);
                    while (opModeIsActive() &&
                            (runtime.milliseconds() < timeout_ms) &&
                            (robot.FLMotor.isBusy() && robot.FRMotor.isBusy())) {
                    }
