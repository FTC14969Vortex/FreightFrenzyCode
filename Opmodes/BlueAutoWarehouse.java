...
/**
 ...
 This file's path is: FtcRobotController/TeamCode/java/org.firstinspires.ftc.teamcode/Opmodes/BlueAutoWarehouse.java
 **/
...
@Autonomous(name="New Blue Warehouse", group="Linear Opmode")
        ...
        while (opModeIsActive()) {
            ...
            switch (autoStep) {
                ...
                case deliver:
                    ...
                    robot.turnRobot(330);
                    robot.robotStop();
                    robot.alignStraight(robot.getRobotAngle(),  35, 0.1);
                    robot.robotStop();
