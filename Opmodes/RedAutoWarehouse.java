...
/**
 ...
 This file's path is: FtcRobotController/TeamCode/java/org.firstinspires.ftc.teamcode/Opmodes/RedAutoWarehouse.java
 **/
...
@Autonomous(name="New Red Warehouse", group="Linear Opmode")
public class RedAutoWarehouse extends LinearOpMode {
    ...
    public enum AutoStep {
        detectDuck, movetoAllianceHub, deliver, turnIntake, preCarousel, park, endAuto
    }
        ...
        while (opModeIsActive()) {
            ...
            switch (autoStep) {
                ...
                case movetoAllianceHub:
                     ...
                     */
                    robot.startStrafeToPosition(0.5, -2);
                    while (opModeIsActive() &&
                            (runtime.milliseconds() < timeout_ms) &&
                            (robot.FLMotor.isBusy() && robot.FRMotor.isBusy())) {
...
//                  robot.arm.setPower(ARM_HOLDING_POWER);
                ...
                case park:
                    runtime.reset();
                    timeout_ms = 5000;
                    robot.startStrafeToPosition(0.5, -35);
                    while (opModeIsActive() &&
                            (runtime.milliseconds() < timeout_ms) &&
                            (robot.FLMotor.isBusy() && robot.FRMotor.isBusy())) {
                    }
