...
/**
 ...
 This file's path is: FtcRobotController/TeamCode/java/org.firstinspires.ftc.teamcode/Opmodes/RedAutoCarouselParkWarehouse.java
 **/
...
@Autonomous(name="New Red Carousel Warehouse Park", group="Linear Opmode")
public class RedAutoCarouselParkWarehouse extends LinearOpMode {
...
//                    sleep(100);
                    runtime.reset();
                    robot.startStrafeToPosition(0.5, 66); //diff from blue
                    while (opModeIsActive() &&
                            (runtime.milliseconds() < timeout_ms) &&
                            (robot.FLMotor.isBusy() && robot.FRMotor.isBusy())) {
                    }
...
//                    autoStep = AutoStep.park;
                ...
                case park:
                    ...
                    robot.turnRobot(268);
                    robot.robotStop();
                    //This two line causing issues
//                    robot.alignStraight(robot.getRobotAngle(),  270, 0.2);
//                    robot.robotStop();
                    ...
                    robot.stopDriveMotors();
                    runtime.reset();
                    robot.startDriveToPosition(0.8, -160);
                    timeout_ms = 5000;
                    while (opModeIsActive() &&
                            (runtime.milliseconds() < timeout_ms) &&
                            (robot.FLMotor.isBusy() && robot.FRMotor.isBusy())) {
